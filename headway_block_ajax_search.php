...
define('AJAXSEARCH_BLOCK_VERSION', '0.1.0');
define('AJAXSEARCH_BLOCK_URL', plugin_dir_url(__FILE__));
define('AJAXSEARCH_BLOCK_PATH', dirname(__FILE__) . '/');
